    ...
    const revisionTask = (async () => {
        try {
            ...
            await prisma.conversation.create({
                data: {
                    role: "assistant",
                    content: "I've made the changes to your website! You can now preview it and request any further changes.",
                    projectId,
                },
            });
            ...
            await prisma.conversation.create({
                data: {
                    role: "assistant",
                    content: "Something went wrong while applying your changes. Please try again.",
                    projectId,
                },
            });
            console.log(error.code || error.message);
