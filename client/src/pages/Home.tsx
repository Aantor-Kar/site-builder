    ...
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className={`ml-auto flex items-center gap-2 rounded-md px-4 py-2 bg-gradient-to-r from-[#CB52D4] to-indigo-600 ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
        >
          {!loading ? (
            "Create with AI"
          ) : (
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-18 max-w-[930px] w-full">
        <div className="text-center">
          <h2 className="font-medium text-2xl md:text-3xl text-gray-400">20+</h2>
          <p className="text-xs md:text-sm text-gray-600">Years Experience</p>
        </div>
        <div className="text-center">
          <h2 className="font-medium text-2xl md:text-3xl text-gray-400">12K+</h2>
          <p className="text-xs md:text-sm text-gray-600">Projects Completed</p>
        </div>
        <div className="text-center">
          <h2 className="font-medium text-2xl md:text-3xl text-gray-400">5K+</h2>
          <p className="text-xs md:text-sm text-gray-600">Happy Customers</p>
        </div>
        <div className="text-center">
          <h2 className="font-medium text-2xl md:text-3xl text-gray-400">5+</h2>
